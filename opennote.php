...
<div class="row">
    ...
    <!-- mian section, retrieve a single textfile-->
    <div class="maincol">
        <p style="font-family: Jura; font-size: 30px">Open Note</p>
        <div class="w3-card-4">
            ...
            <form role="form" class="w3-container" name="addNote" id="addSticky" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                <label class="w3-text-black" style="font-family: Jura" for="file"><b>File Name: </label>
                <input type="text" id="filename" name="filename" style="width:50%; font-family: Jura; font-size: 20px"
                       class="form-control" required data-validation-required-message="You must enter a title" maxlength="25"><br>
                <button type="submit" value="Submit" class="btn btn-primary pull-right" style="margin-bottom:10px; width:20%; font-family: Jura; font-size: 20px">Open</button><br>
            </form>
